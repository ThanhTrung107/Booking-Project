...
module.exports.viewLogin = (req, res) => {
  //GET /views/login
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/user/Login.html'));
}
module.exports.viewHome = (req, res) => {
  //GET /views/menu
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/user/Menu.html'));
}
...
module.exports.viewRegister = (req, res) => {
  //GET /views/register
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/user/Register.html'));
}
module.exports.viewForgotPassword = (req, res) => {
  //GET /views/register
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/user/Forgot.html'));
}
module.exports.viewCheckOTP = (req, res) => {
  //GET /views/register
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/user/OTP.html'));
}
module.exports.viewLocation = (req, res) => {
  //GET /views/register
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/user/luutru.html'));
}
module.exports.viewDetail = (req, res) => {
  //GET /views/register
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/user/chitiet.html'));
}
module.exports.viewResetPassword = (req, res) => {
  //GET /views/register
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/user/Resetpassword.html'));
}
module.exports.viewAfterMenu = (req, res) => {
  //GET /views/register
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/user/afterMenu.html'));
}
