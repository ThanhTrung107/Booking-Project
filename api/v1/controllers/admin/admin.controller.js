...
module.exports.viewLogin = (req, res) => {
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/admin/Login.html'));
}
module.exports.viewRegister = (req, res) => {
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/admin/Register.html'));
}
module.exports.viewDashboard = (req, res) => {
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/admin/index.html'));
}
module.exports.viewRoom = (req, res) => {
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/admin/room.html'));
}
module.exports.viewRole = (req, res) => {
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/admin/role.html'));
}
module.exports.viewAccount = (req, res) => {
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/admin/account.html'));
}
module.exports.viewCategory = (req, res) => {
  res.sendFile(path.join(__dirname, '../../../../travel-booking/views/admin/category.html'));
}
